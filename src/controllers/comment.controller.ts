...
const getVideoComments = asyncHandler(async (req, res) => {
    ...
    // return response
    return res.status(200).json(new ApiResponse(200, comments, "Comments fetched sucessfully"));
});
...
const updateComment = asyncHandler(async (req, res) => {
    ...
    const updatedComment = await Comment.findByIdAndUpdate(req.comment?._id, req.body, { new: true });
