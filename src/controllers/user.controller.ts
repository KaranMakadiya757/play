...
const refereshAccessToken = asyncHandler(async (req, res) => {
    ...
    //  VERIFY THE TOKEN
    const decodedToken = jwt.verify(incomingRefreshToken, process.env.REFERSH_TOKEN_SECRET ?? "") as Token;
    ...
    return res
        ...
        .cookie("accessToken", accessToken, cookieOption)
        .cookie("refreshToken", refreshToken, cookieOption)
        .json(new ApiResponse(200, { accessToken, refreshToken }, "Referesh Token generated sucessfully"));
});
