...
const toggleSubscription = asyncHandler(async (req, res) => {
    ...
    if (!subscription) {
        ...
        // Return response
        return res.status(201).json(new ApiResponse(200, {}, "Subscription added"));
    } else {
        ...
        // Return Response
        return res.status(201).json(new ApiResponse(200, {}, "Subscription removed"));
    }
});
...
const getUserChannelSubscribers = asyncHandler(async (req, res) => {
    ...
    // Return response
    return res.status(200).json(new ApiResponse(200, subscriberList, "Subscriber list fetched sucessfully"));
});
